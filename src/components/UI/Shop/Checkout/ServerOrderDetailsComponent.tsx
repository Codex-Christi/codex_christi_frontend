...
type ServerOrderDetailsType = Awaited<
  ReturnType<typeof getOrderFinalDetails>
> | null;

export const ServerOrderDetailsContext = createContext<
  ServerOrderDetailsType | undefined
>(undefined);

export const ServerOrderDetailsComponent: FC<{ children?: ReactNode }> = ({
  children,
}) => {
  // Hooks
  ...
  const [serverOrderDetails, setServerOrderDetails] =
    useState<ServerOrderDetailsType>(null);
