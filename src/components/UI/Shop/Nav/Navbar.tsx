...
const ShopNav: FC = () => {
	...
	return (
		<>
			<nav
				role="navigation"
				className={`!z-[99] relative pointer-events-auto ${pathname === "/shop" ? "bg-blue-700/40" : "bg-black"} backdrop-blur-[2px] flex justify-between
			...
			>
				<section className="flex gap-5 md:gap-10">
					...
					<Button
						...
						variant="link"
						onClick={() =>
							setIsSidebarOpen((prevSate) => !prevSate)
						}
					>
						<svg
