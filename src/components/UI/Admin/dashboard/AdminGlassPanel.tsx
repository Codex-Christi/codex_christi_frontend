...
export const adminPageMainClass =
  'min-h-dvh bg-[#141923] px-4 pb-6 pt-24 text-slate-50 [background:radial-gradient(circle_at_76%_14%,rgba(14,165,233,0.10),transparent_24%),linear-gradient(180deg,rgba(30,35,47,0.82),rgba(16,21,31,0.94))] supports-[backdrop-filter]:backdrop-blur-[1px] sm:px-6 lg:px-8';
