...
import { resetPasswordSchema, resetPasswordSchemaType } from '@/lib/formSchemas/resetPasswordSchema';
...
const ForgotPassword = () => {
	...
	const resetPassword = useForm<resetPasswordSchemaType>({
	...
	const resetPasswordSubmitHandler: SubmitHandler<resetPasswordSchemaType> = async (
		fieldValues,
		event,
	) => {
	...
	return (
		<Form {...resetPassword}>
			<form
				onSubmit={resetPassword.handleSubmit(resetPasswordSubmitHandler)}
			...
			>
				...
				<PasswordInput
                    currentZodForm={resetPasswordSchema}
                    inputName="password"
                />
