...
const UserIcon: IconType = () => (
	...
	>
		<g
			data-testid="Group-148"
			opacity="1"
		>
			<g data-testid="Vector-2273">
				<g
					data-testid="svg-path-1470"
					opacity="1"
				>
					<path
						fill="#fff"
			...
			render={({ field }) => (
				<FormItem className="w-full">
					<FormLabel className="text-white">{`${
						inPutNamePt1.charAt(0).toUpperCase() +
						inPutNamePt1.slice(1)
					}name`}</FormLabel>
					<FormControl>
						<InputWithIcon
							startIcon={UserIcon}
