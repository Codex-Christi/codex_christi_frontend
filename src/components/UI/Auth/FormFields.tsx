...
export interface BaseZodInputProps<T extends FieldValues> {
  currentZodForm: UseFormReturn<T>;
}

// Interfaces
interface NameInputInterface<T extends FieldValues>
  extends BaseZodInputProps<T> {
  inputName: 'firstname' | 'lastname';
  currentZodForm: UseFormReturn<T>;
}

interface EmailInputProps<T extends FieldValues> extends BaseZodInputProps<T> {
  inputName: 'email';
  currentZodForm: UseFormReturn<T>;
  label?: string;
}
