...
const EditProfileModal = ({
	...
	return (
		<div
			className={cn(
				"bg-[#0D0D0D]/[.98] backdrop-blur-lg text-white fixed top-[calc(4rem+1.40rem)] p-8 w-[90%] left-[5%] space-y-8 transition-transform md:w-1/2 h-[calc(100dvh-6rem)] overflow-y-auto md:left-[25%] duration-300 ease-linear rounded-[10px] -translate-y-[200%] shadow-2xl lg:w-2/5 lg:left-[30%] z-[1024]",
				{
