...
# - installs deps only once (deps)
# - builds in builder stage (yarn build)
# - copies only needed runtime artifacts into production
# - uses BuildKit cache mounts for fast repeated builds
###############################################################################
